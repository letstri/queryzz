...
export function useQuery<T extends Value>(key: string, options: Options & { array: true }): Ref<T[] | undefined>
export function useQuery(key: string, options: Options & { array: true, parse: false }): Ref<string[] | undefined>
